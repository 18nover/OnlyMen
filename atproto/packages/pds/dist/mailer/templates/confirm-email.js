...
// src/mailer/templates/confirm-email.hbs
var Handlebars = __toESM(require_runtime2(), 1);
Handlebars.registerHelper({});
Handlebars.registerPartial({});
var confirm_email_default = Handlebars.template({ "1": function(container, depth0, helpers, partials, data) {
  ...
  return '\n                        or<!-- -->\n                        <a\n                          href="https://bsky.app/intent/verify-email?code=' + alias2(alias1(depth0 != null ? lookupProperty(depth0, "token") : depth0, depth0)) + '"\n                          style="color:' + alias2(alias1((stack1 = depth0 != null ? lookupProperty(depth0, "config") : depth0) != null ? lookupProperty(stack1, "primaryColor") : stack1, depth0)) + ';text-decoration:none;text-decoration-line:underline;font-size:16px;letter-spacing:0.25px"\n                          target="_blank"\n                        >click here</a>';
