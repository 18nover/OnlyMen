...
// src/mailer/templates/delete-account.hbs
var Handlebars = __toESM(require_runtime2(), 1);
Handlebars.registerHelper({});
Handlebars.registerPartial({});
var delete_account_default = Handlebars.template({ "compiler": [8, ">= 4.3.0"], "main": function(container, depth0, helpers, partials, data) {
