...
const $nsid = 'com.example.byteLength'

export { $nsid }

type Main = { $type: 'com.example.byteLength'; bytes?: Uint8Array }
...
const main = /*#__PURE__*/ l.record<'any', Main>(
  ...
  $nsid,
  /*#__PURE__*/ l.object({
    bytes: /*#__PURE__*/ l.optional(
      /*#__PURE__*/ l.bytes({ minLength: 2, maxLength: 4 }),
    ),
  }),
)
