...
const $nsid = 'com.example.stringLengthGrapheme'

export { $nsid }

type Main = { $type: 'com.example.stringLengthGrapheme'; string?: string }
...
const main = /*#__PURE__*/ l.record<'any', Main>(
  ...
  /*#__PURE__*/ l.object({
    string: /*#__PURE__*/ l.optional(
      /*#__PURE__*/ l.string({ minGraphemes: 2, maxGraphemes: 4 }),
    ),
  }),
)
