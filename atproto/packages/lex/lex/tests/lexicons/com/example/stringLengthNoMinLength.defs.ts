...
const $nsid = 'com.example.stringLengthNoMinLength'

export { $nsid }

type Main = { $type: 'com.example.stringLengthNoMinLength'; string?: string }
...
const main = /*#__PURE__*/ l.record<'any', Main>(
  ...
  $nsid,
  /*#__PURE__*/ l.object({
    string: /*#__PURE__*/ l.optional(/*#__PURE__*/ l.string({ maxLength: 4 })),
  }),
)
